...
panel.innerHTML = `
  <div class="fp-header">
    ...
    <div class="fp-header-right">
      ...
      <button class="fp-refresh-btn" title="Refresh file list">&#8635;</button>
      <button class="fp-close-btn" title="Close panel">&times;</button>
    </div>
  </div>
  <div class="fp-body">
...
toggleBtn.title = 'Toggle file panel';
...
async function openFile(f) {
  ...
  previewMeta.innerHTML = `
    ...
    <a class="fp-meta-download" href="${escapeAttr(dlUrl)}" download="${escapeAttr(currentFile.name)}" target="_blank" title="Download">&#8595; Download</a>
  `;
