...
panel.innerHTML = `
  ...
  <div class="dev-toolbar">
    <span class="dev-toolbar-title">WebSocket Traffic</span>
    <div class="dev-toolbar-controls">
      <select id="dev-filter" title="Filter by type">
        <option value="all">All</option>
        <option value="sent">Sent</option>
        <option value="received">Received</option>
        <option value="llm">LLM Traces</option>
        <option value="status">Status</option>
      </select>
      <label class="dev-autoscroll-label">
        <input type="checkbox" id="dev-autoscroll" checked> Auto-scroll
      </label>
      <button id="dev-clear" title="Clear log">Clear</button>
    </div>
  </div>
